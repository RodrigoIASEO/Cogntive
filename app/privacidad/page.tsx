...
function PrivacyPage() {
  return (
    <main className="flex-grow px-4 py-24 md:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-12">Política de Privacidad</h1>
        <div className="prose prose-invert max-w-none space-y-16">
          <p className="text-justify">
            Rodrigo de la Torre Sanchez y Jorge Daniel Carreon Guzman (en adelante, Cognitive Data Solutions), en su carácter de Responsables del tratamiento de los datos personales, pone a su disposición el presente Aviso de Privacidad Integral...
          </p>

          <section className="space-y-6">
            <h2 className="text-2xl font-semibold mb-8">Identificación del Responsable</h2>
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-semibold mb-8">Dirigido a</h2>
            <p className="text-justify">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-semibold mb-8">Recolección de Datos Personales</h2>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-semibold mb-4">Datos de Identificación:</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4">Datos Financieros (para reembolsos):</h3>
                <ul className="list-disc list-inside space-y-1">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4">Datos de Navegación web:</h3>
                <ul className="list-disc list-inside space-y-1">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-semibold mb-8">Obtención de tus Datos</h2>
            <p className="text-justify">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-semibold mb-8">Finalidad del Tratamiento de Datos Personales</h2>
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-semibold mb-4">Finalidad Primaria:</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4">Finalidad Secundaria:</h3>
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-semibold mb-8">Transferencia de Datos a Terceros</h2>
            <p className="text-justify mb-4">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-semibold mb-8">Derechos ARCO</h2>
            <p className="text-justify mb-4">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-semibold mb-8">Ejercicio de Derechos ARCO</h2>
            <p className="text-justify mb-4">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-semibold mb-8">Consentimiento</h2>
            <p className="text-justify mb-4">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-semibold mb-8">Autoridad Competente</h2>
            <p className="text-justify">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-semibold mb-8">Uso de Cookies y Web Beacons</h2>
            <p className="text-justify mb-4">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-semibold mb-8">Cambios al Aviso de Privacidad</h2>
            <p className="text-justify">
